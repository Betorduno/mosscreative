...
export default {
    ...
    head: {
        ...
        script: [
            { src: '/assets/vendor/jquery/js/jquery.min.js' }, { src: '/assets/vendor/jquery/js/jquery-ui.min.js' }, { src: '/assets/vendor/bootstrap/js/bootstrap.min.js' }, { src: '/assets/vendor/pace.min.js' }, { src: '/assets/vendor/jquery.easing.min.js' }, { src: '/assets/vendor/isotope.pkgd.min.js' }, { src: '/assets/vendor/imagesloaded.pkgd.min.js' }, { src: '/assets/vendor/jquery.mousewheel.min.js' }, { src: '/assets/vendor/owl-carousel/js/owl.carousel.min.js' }, { src: '/assets/vendor/magnific-popup/js/jquery.magnific-popup.min.js' }, { src: '/assets/vendor/ytplayer/js/jquery.mb.YTPlayer.min.js' }, { src: '/assets/js/theme.js' }
        ],
        link: [
    ...
    build: {
        ...
        // RewriteCond %{HTTP_HOST} ^(www\.)?mosscreativo\.com
        // RewriteRule ^(.*)$ https://www.mosscreativo.com/$1 [R,L]
        extend(config, ctx) {},
        router: {
            base: '/'
        },
